...
namespace MoonPdfCore
{
    public class Commands
    {
        ...
        public Commands(MainWindow wnd)
        {
            ...
            this.SinglePageCommand = new DelegateCommand("Single page", f => { pdfPanel.ViewType = MoonPdfLibCore.ViewType.SinglePage; }, isPdfLoaded, new KeyGesture(Key.D1, ModifierKeys.Control));
            this.FacingCommand = new DelegateCommand("Facing", f => { pdfPanel.ViewType = MoonPdfLibCore.ViewType.Facing; }, isPdfLoaded, new KeyGesture(Key.D2, ModifierKeys.Control));
            this.BookViewCommand = new DelegateCommand("Book view", f => { pdfPanel.ViewType = MoonPdfLibCore.ViewType.BookView; }, isPdfLoaded, new KeyGesture(Key.D3, ModifierKeys.Control));
